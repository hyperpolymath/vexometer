...
vexometer a harassment-free experience for everyone, regardless of age,
...
. The maintainer team will review the report
...
The maintainer team will follow these guidelines in determining
consequences:
...
* Appeals are reviewed by a different maintainer team member than the
original
...
* Open a
https://github.com/hyperpolymath/vexometer/discussions[Discussion] (for
general questions)
