...
Vexometer processes potentially sensitive: - User prompts - Model
responses - API credentials

We assume: - Local execution is trusted - Remote APIs may be compromised
