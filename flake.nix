{
  description = "vexometer - {project-description}";
      ...
      in
      {
        ...
        packages.default = pkgs.stdenv.mkDerivation {
          ...
          buildPhase = ''
            ...
            # For Ada: gprbuild -P vexometer.gpr -XMODE=release
          '';

          installPhase = ''
            mkdir -p $out/bin
            # *REMINDER: Add install commands*
            # cp target/release/vexometer $out/bin/  # Rust
            # cp bin/vexometer $out/bin/  # Ada
          '';
        ...
        apps.default = {
          type = "app";
          program = "${self.packages.${system}.default}/bin/vexometer";
        };
        ...
        checks = {
          ...
          test = pkgs.runCommand "test-vexometer" {
