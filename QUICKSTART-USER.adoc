...
// Replace vexometer, Vexometer — See README.adoc for details., just run, Vexometer started successfully. with actuals
= vexometer — Quick Start for Users
:toc:
:toclevels: 2

== What is vexometer?

Vexometer — See README.adoc for details.
...
[source,bash]
----
just install --portable --prefix=./vexometer-portable
----
...
[source]
----
Vexometer started successfully.
----
...
* **Wiki**: https://github.com/hyperpolymath/vexometer/wiki
