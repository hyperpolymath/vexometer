...
vext provides flexible, powerful IRC notifications for your
repositories. Start with the basic examples and expand based on your
specific needs. For more information, see README.md and FEATURES.md.
