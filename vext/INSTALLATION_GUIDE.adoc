...
* *Version Control Tools*: Git, Mercurial (optional), or Subversion
(optional)
* *Network*: Outbound TCP/UDP access to IRC server
* *User Privileges*: Ability to create system users and install to
`+/usr/local+` or `+/opt+`
...
* *Outbound*: TCP/UDP port 6667-6697 (IRC servers, 6697 is typically
TLS)
...
After installation, see: - USAGE_GUIDE.md for operating vext -
CONFIGURATION.md for detailed configuration options - README.md for
project overview
