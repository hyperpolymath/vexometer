...
// Replace vexometer, {{PACKAGE_NAME}}, {{DEPS}} with actuals
= vexometer — Quick Start for Platform Maintainers
:toc:
:toclevels: 2

== Overview

This guide covers packaging, deploying, and maintaining vexometer for
...
* Upstream: https://github.com/hyperpolymath/vexometer/issues
