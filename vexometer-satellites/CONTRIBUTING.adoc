...
git clone https://github.com/hyperpolymath/vexometer.git cd vexometer
...
toolbox create vexometer-dev toolbox enter vexometer-dev # Install
...
vexometer/ ├── src/ # Source code (Perimeter 1-2) ├── lib/ # Library
